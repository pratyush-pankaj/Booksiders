		...
		<article>
			...
			<div class="page">
				...
				<div id="topPanel">
					...
					<div id="topLeft">
						<div id="logoSpace">
							<img src="images/logo5.png" width="200" height="200" class="topLogo" />
						</div>
						
						<h1>BOOKSIDERS.COM</h1>	
						<p>Sell and Share</p>
						<div class="topButtonHolder">
							<a href="sellForm_login_check.php"><button class="basicButton">Start Selling</button></a>
						</div>
						<div class="clear"></div>
					</div>
					...
					<div id="topRight">	
						<div id="topRatedBooks">
							...
							<?php
							while($bookrow = mysql_fetch_array($bookByRating))
							{
							?>
								<a href="book.php?isbn=<?php echo $bookrow['isbn']; ?>"><img src="<?php echo $bookrow['img']; ?>" class="topBooks" /></a>
							<?php	
							}
							?>
						...
						<a href="allBooks.php"><p class="showAllBooks">Click Here to view all books on sale</p></a>

						<div id="shareLocation">
							<p>Share Location To Find Books Near You:</p>
							<form class="locationForm" action="#" method="POST" >
	        ...
	        placeholder="Enter Landmark/Institute/Addresses Eg. Adarsh Nagar">
							    ...
							    <img class="loadEffectLocation" src="images/Preloader_3.gif" />
							</form>
						</div>
			...
			<div id="rowTwo">
				<div class="line-clear"></div>
				<div id="buyAndSell" class="rowTwo">
					<h4>Buy And Sell</h4>
					<p>Find a suitable person to buy or sell your books</p>
					<a href="signUp.php"><button>SignUp for Buy/Sell</button></a>
					<div class="clear"></div>
				</div>
				
				<div id="bookStoreBlock" class="rowTwo">
					<h4>BookStore</h4>
					<p>Open your online Bookstore and start earning</p>
					<a href="store/"><button>SignUp for BookStore</button></a>
					<div class="clear"></div>
				</div>
				
				<div id="insideBlock" class="rowTwo">
					<h4>Inside&copy;</h4>
					<p>Get inside reviews for all the books before u buy it.</p>
					<a href="inside/"><button>Visit Booksiders Inside</button></a>
					<div class="clear"></div>
				</div>
				<div class="line-clear"></div>	
			...
			<div id="publishRow">
				<div class="page">
					...
					<p>Are you one of those people who loves writing but you dont have publishers. Well now BookSiders provides you a platform to show your creativity and even publish your work. Publish your books for FREE.</p>
			...
			<div class="page">
				<div id="investRow">
					...
					<div id="investLogo" class="investLogo"></div>
					<div id="investInfo" class="investInfo">
						<h3>Invest in Us</h3>
						<p>Anyone can invest in our venture. We are providing all the services free of cost. So please if you are kind enough and you like our work then contact us for investing in us.</p>
