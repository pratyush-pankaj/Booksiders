			...
			<div class="page">
				...
				<div id="adSection">
					<div id="sectionLeft">
						...
						<div id="rightOfImage">
						<p>Category: <?php echo $row['category'], " ,", $row['category2']," ,", $row['category3']," ,", $row['category4']; ?></p>

						<p>Condition: <?php echo $row['description']; ?></p>

						<p style="text-decoration: line-through;">Original Price: <?php echo $row['org_price']; ?></p>
						<p>Offered Price: Rs. <?php echo $row['price']; ?></p>
						<p>User Rating:</p>
				        ...
				        <p class="bordered">Ad Quality: <?php echo $row["ad_quality"]; ?>%</p>
					...
					<div id="selectionRight">
						<p class="userName"><?php echo $row['name']; ?></p>
						<p class="phone"><?php echo $row['phone']; ?></p>
						<p class="landmark"><?php echo $row['landmark']; ?></p>
						<p class="address"><?php echo $row['city']; ?></p>

						<h5>Date of Ad: <?php echo $row["ad_date"]; ?></h5>

						<button>Report This Ad</button>
					</div>
