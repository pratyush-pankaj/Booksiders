...
<!-- Meta Ends -->
	...
	<body class='signUpBody InBody'>
		...
		?>
			<div id="messageBox">
				<p>Email Address Already Exists. Try another or login.</p>
			</div>
		<?php
		}
		?>
		...
		?>
			<div id="messageBox">
				<p>Please tick I'm not a robot.</p>
			</div>
		<?php
		}
		?>
		...
		<div id="loginBox">
			<h1>Sign Up for BookSiders</h1>

			<form id="loginForm" action="db_signup.php" method="POST">
				<input type="text" class="loginInput" name="name" placeholder="Your Name" value="" />

				<input type="email" class="loginInput" name="email" placeholder="Email Id" value="" />
				<input type="password" class="loginInput" name="password" placeholder="Password" value="" />

				<div class="g-recaptcha" data-sitekey="6LcdRgsTAAAAAOcVJa429_CZqv2Cmweyv7FbdoKk"></div>

				<input type="submit" value="Fire Up!" class= "loginButton" />

				<button class="loginButton facebookButton">Register via Facebook</button>

				<p class="newTo">Already a member? <a href="signIn.php">Login Here.</a></p>

				<p class="noteTerms">Note: By signing up, you agree to our <a href="#">Terms &amp; Conditions</a></p>
			</form>
		</div>
