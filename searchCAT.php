...
function searchLoad()
	...
	<body class="searchBody" onLoad="searchLoad();">
				...
				<div id="searchArea">
					<div id="resultRow">
						<?php        
									...
									//$q1 = 'SELECT * FROM book_ad WHERE bname like $search or author like "%harry%" or isbn like "%harry%" ';
									$q1	= "SELECT * FROM book_ad WHERE category='$cat' OR category2='$cat' OR category3='$cat' OR category4='$cat'";
						...
						<div class="bookHolder" style="background:url(<?php echo $sresult['img'];?>) no-repeat;background-size:100% 100%;">
							<div class="bookCover">
								<a href="adPage.php?ad_id=<?php echo $sresult['ad_id']; ?>"><p><?php echo  $sresult['bname'];?></p>
								<p><?php echo  $sresult['price'];?></p></a>
							</div>
						</div>
		...
		<div id="filterBox">
			<div id="filterCentre">
				...
				<div>
					<span>By City:</span>
					<input class="pickCity" id="pickCity" type="text" readonly/>
				</div>

				<div>
					<span>By Category:</span>
					<input type="text" class="pickCategory" id="pickCategory" readonly />
				</div>

				<div>
					<span>By Landmark:</span>
